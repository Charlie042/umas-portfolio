...
const About = () => {
  return (
    ...
    <motion.p key={paragraph.id} initial={{opacity: 0, y: 15}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5, ease: "easeInOut"}} className="relative w-[300px] sm:w-full mx-auto text-base">
          {paragraph.text}
      </motion.p>
        ))}
    </div>
